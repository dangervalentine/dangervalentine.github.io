    ...
    return (
        <div className={styles.container}>
            <div className={styles.content}>
                ...
                <p className={styles.lastUpdated}>Last updated Feburary 4, 2026</p>

                <section className={styles.section}>
                    <p className={styles.text}>
                        This Privacy Notice for <strong>NextQuest</strong> (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), describes how and why we might access, collect, store, use, and/or share (&quot;process&quot;) your personal information when you use our services (&quot;Services&quot;), including when you:
                    </p>
                    <ul className={styles.list}>
                        <li>Download and use our mobile application (NextQuest), or any other application of ours that links to this Privacy Notice</li>
                    ...
                    <p className={styles.text}>
                        ...
                        <a href="mailto:danger@nextquest.dev" className={styles.link}>
                            danger@nextquest.dev
                        </a>.
                    </p>
                </section>
                ...
                <section className={styles.section} id="summary">
                    ...
                    <p className={styles.text}>
                        <em>This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our{' '}
                            <Link href="#toc" className={styles.link}>table of contents</Link> below to find the section you are looking for.</em>
                    </p>
                    <p className={styles.text}>
                        ...
                        <Link href="#personalinfo" className={styles.link}>personal information you disclose to us</Link>.
                    </p>
                    <p className={styles.text}>
                    ...
                    <p className={styles.text}>
                        ...
                        <Link href="#infouse" className={styles.link}>how we process your information</Link>.
                    </p>
                    <p className={styles.text}>
                        ...
                        <Link href="#whoshare" className={styles.link}>when and with whom we share your personal information</Link>.
                    </p>
                    <p className={styles.text}>
                        ...
                        <Link href="#infosafe" className={styles.link}>how we keep your information safe</Link>.
                    </p>
                    <p className={styles.text}>
                        ...
                        <Link href="#privacyrights" className={styles.link}>your privacy rights</Link>.
                    </p>
                    <p className={styles.text}>
                        <strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by visiting{' '}
                        <Link href="https://nextquest.dev/privacy" className={styles.link}>https://nextquest.dev/privacy</Link>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
                    </p>
                    <p className={styles.text}>
                        Want to learn more about what we do with any information we collect?{' '}
                        <Link href="#toc" className={styles.link}>Review the Privacy Notice in full</Link>.
                    </p>
                </section>
                ...
                <section className={styles.section} id="toc">
                    ...
                    <ul className={styles.list}>
                        <li><Link href="#infocollect" className={styles.link}>1. WHAT INFORMATION DO WE COLLECT?</Link></li>
                        <li><Link href="#infouse" className={styles.link}>2. HOW DO WE PROCESS YOUR INFORMATION?</Link></li>
                        <li><Link href="#legalbases" className={styles.link}>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</Link></li>
                        <li><Link href="#whoshare" className={styles.link}>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</Link></li>
                        <li><Link href="#inforetain" className={styles.link}>5. HOW LONG DO WE KEEP YOUR INFORMATION?</Link></li>
                        <li><Link href="#infosafe" className={styles.link}>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</Link></li>
                        <li><Link href="#privacyrights" className={styles.link}>7. WHAT ARE YOUR PRIVACY RIGHTS?</Link></li>
                        <li><Link href="#DNT" className={styles.link}>8. CONTROLS FOR DO-NOT-TRACK FEATURES</Link></li>
                        <li><Link href="#uslaws" className={styles.link}>9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</Link></li>
                        <li><Link href="#policyupdates" className={styles.link}>10. DO WE MAKE UPDATES TO THIS NOTICE?</Link></li>
                        <li><Link href="#contact" className={styles.link}>11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Link></li>
                        <li><Link href="#request" className={styles.link}>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</Link></li>
                    </ul>
                </section>

                <section className={styles.section} id="infocollect">
                    <h2 className={styles.sectionTitle}>1. WHAT INFORMATION DO WE COLLECT?</h2>
                    <div className={styles.subsection} id="personalinfo">
                    ...
                    <div className={styles.subsection}>
                        ...
                        <p className={styles.text}>
                            ...
                            <a href="https://developers.google.com/terms/api-services-user-data-policy#limited-use" target="_blank" rel="noopener noreferrer" className={styles.link}>
                ...
                <section className={styles.section} id="legalbases">
                    <h2 className={styles.sectionTitle}>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
                    <p className={styles.text}>
                    ...
                    <ul className={styles.list}>
                        <li>
                            ...
                            <Link href="#withdrawconsent" className={styles.link}>withdrawing your consent</Link>.
                        </li>
                        <li>
                    ...
                    <p className={styles.text}>
                        ...
                        <Link href="#withdrawconsent" className={styles.link}>withdraw your consent</Link> at any time.
                    </p>
                    <p className={styles.text}>
                ...
                <section className={styles.section} id="inforetain">
                    <h2 className={styles.sectionTitle}>5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                    <p className={styles.text}>
                ...
                <section className={styles.section} id="infosafe">
                    <h2 className={styles.sectionTitle}>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                    <p className={styles.text}>
                ...
                <section className={styles.section} id="privacyrights">
                    <h2 className={styles.sectionTitle}>7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                    <p className={styles.text}>
                    ...
                    <p className={styles.text}>
                        ...
                        <Link href="#contact" className={styles.link}>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Link> below.
                    </p>
                    <p className={styles.text}>
                    ...
                    <p className={styles.text}>
                        ...
                        <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" target="_blank" rel="noopener noreferrer" className={styles.link}>
                            Member State data protection authority
                        </a> or{' '}
                        <a href="https://ico.org.uk/make-a-complaint/data-protection-complaints/data-protection-complaints/" target="_blank" rel="noopener noreferrer" className={styles.link}>
                            UK data protection authority
                        </a>.
                    </p>
                    <p className={styles.text}>
                        If you are located in Switzerland, you may contact the{' '}
                        <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" target="_blank" rel="noopener noreferrer" className={styles.link}>
                            Federal Data Protection and Information Commissioner
                        </a>.
                    </p>
                    <div className={styles.subsection} id="withdrawconsent">
                        <h3 className={styles.subsectionTitle}>Withdrawing your consent:</h3>
                        <p className={styles.text}>
                ...
                <section className={styles.section} id="DNT">
                    <h2 className={styles.sectionTitle}>8. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                    <p className={styles.text}>
                ...
                <section className={styles.section} id="uslaws">
                    <h2 className={styles.sectionTitle}>9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                    <p className={styles.text}>
                    ...
                    <div className={styles.subsection}>
                        ...
                        <p className={styles.text}>
                            ...
                            <Link href="#infocollect" className={styles.link}>WHAT INFORMATION DO WE COLLECT?</Link>.
                        </p>
                    ...
                    <div className={styles.subsection}>
                        ...
                        <p className={styles.text}>
                            ...
                            <Link href="#infouse" className={styles.link}>HOW DO WE PROCESS YOUR INFORMATION?</Link>.
                        </p>
                        <p className={styles.text}>
                        ...
                        <p className={styles.text}>
                            ...
                            <Link href="#whoshare" className={styles.link}>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</Link>.
                        </p>
                        <p className={styles.text}>
                    ...
                    <div className={styles.subsection}>
                        ...
                        <p className={styles.text}>
                            ...
                            <Link href="https://nextquest.dev/privacy" className={styles.link}>https://nextquest.dev/privacy</Link>, by emailing us at{' '}
                            <a href="mailto:danger@nextquest.dev" className={styles.link}>danger@nextquest.dev</a>, or by referring to the contact details at the bottom of this document.
                        </p>
                        <p className={styles.text}>
                    ...
                    <div className={styles.subsection}>
                        ...
                        <p className={styles.text}>
                            ...
                            <a href="mailto:danger@nextquest.dev" className={styles.link}>danger@nextquest.dev</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.
                        </p>
                    </div>
                    <div className={styles.subsection}>
                        ...
                        <p className={styles.text}>
                            ...
                            <Link href="#contact" className={styles.link}>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Link>.
                        </p>
                    </div>
                </section>

                <section className={styles.section} id="policyupdates">
                    <h2 className={styles.sectionTitle}>10. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                    <p className={styles.text}>
                ...
                <section className={styles.section} id="contact">
                    <h2 className={styles.sectionTitle}>11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                    <p className={styles.text}>
                        If you have questions or comments about this notice, you may email us at{' '}
                        <a href="mailto:danger@nextquest.dev" className={styles.link}>danger@nextquest.dev</a> or contact us by post at:
                    </p>
                    <p className={styles.text}>
                        <strong>NextQuest</strong>
                        <br />
                        2101 West 104th Street
                        <br />
                ...
                <section className={styles.section} id="request">
                    <h2 className={styles.sectionTitle}>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                    <p className={styles.text}>
                        ...
                        <Link href="https://nextquest.dev/privacy" className={styles.link}>https://nextquest.dev/privacy</Link>.
                    </p>
                </section>
            </div>
        </div>
